...
public class StudentController {
	...
	public ResponseEntity<Student> getStudent() {
		Student student= new Student(1,"sush","pra");
...
//		return ResponseEntity.ok(student);
	...
	public ResponseEntity<List<Student>> getStudents() {
		...
		student.add(new Student(1,"sush","pra"));
		student.add(new Student(2,"tri","sha"));
		student.add(new Student(3,"nava","nidhi"));
		student.add(new Student(4,"aksh","shuu"));
		return ResponseEntity.ok(student);
